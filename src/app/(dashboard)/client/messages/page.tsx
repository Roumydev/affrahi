    ...
    <div className="w-full h-[calc(100vh-120px)] flex gap-0 bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="w-72 border-r border-gray-100 flex flex-col">
        <div className="p-6 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-1">Your hall owners</p>
        </div>
        <div className="flex-1 overflow-y-auto">
          {contacts.length === 0 ? (
            <div className="p-6 text-center text-gray-400 text-sm">
              No contacts yet — book a hall first
            </div>
          ) : (
            contacts.map((c) => (
              <button
          ...
          <>
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Hall Owner</p>
              </div>
            </div>
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
              ...
              <button
                ...
                className="px-5 py-3 bg-[#8B1538] text-white rounded-xl hover:bg-[#6d102c] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                <Send size={18} />
              </button>
            </div>
